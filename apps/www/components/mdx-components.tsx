...
const components = {
  ...
  figcaption: async ({
    ...
    return (
      <div {...props} className={cn(className, "border border-b-0")}>
        <div className="flex items-center">
          <FileIcon extension={extension} className="w-5 h-5 mr-1.5" />
          {props.children}
        </div>
  ...
  ImageCaption: ({
    ...
    <div className="border rounded-lg mt-4">
      <img className={cn("p-2 dark:invert", className)} src={src} alt={alt} />
  ...
  thead: ({
    ...
    <thead className={cn("border-b bg-muted", className)} {...props} />
  ),
